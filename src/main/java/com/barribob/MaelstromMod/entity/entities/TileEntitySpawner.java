...
public class TileEntitySpawner extends TileEntity implements ITickable
{
    private final MobSpawnerBaseLogic spawnerLogic = new MobSpawnerBaseLogic()
    {
        ...
        {
            TileEntitySpawner.this.world.addBlockEvent(TileEntitySpawner.this.pos, ModBlocks.AZURE_MAELSTROM_CORE, id, 0);
        }
        public World getSpawnerWorld()
        {
            return TileEntitySpawner.this.world;
        }
        public BlockPos getSpawnerPosition()
        {
            return TileEntitySpawner.this.pos;
        }
        public void setNextSpawnData(WeightedSpawnerEntity p_184993_1_)
        {
            ...
            if (this.getSpawnerWorld() != null)
            {
                ...
                this.getSpawnerWorld().notifyBlockUpdate(TileEntitySpawner.this.pos, iblockstate, iblockstate, 4);
            }
        }
    };
    ...
    public static void registerFixesMobSpawner(DataFixer fixer)
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new IDataWalker()
        {
            ...
            {
                if (TileEntity.getKey(TileEntitySpawner.class).equals(new ResourceLocation(compound.getString("id"))))
                {
