...
public class ModBlocks
{
    ...
    public static final Block BLUE_DAISY = new BlockAzureFlower("blue_daisy", Material.PLANTS, PLANTS_HARDNESS, PLANTS_RESISTANCE, SoundType.PLANT)
	    .setCreativeTab(ModCreativeTabs.ALL);
    public static final Block RUBY_ORCHID = new BlockAzureFlower("ruby_orchid", Material.PLANTS, PLANTS_HARDNESS, PLANTS_RESISTANCE, SoundType.PLANT)
	    .setCreativeTab(ModCreativeTabs.ALL);
    public static final Block DOUBLE_BROWNED_GRASS = new BlockDoubleBrownedGrass("double_browned_grass", Material.PLANTS, PLANTS_HARDNESS, PLANTS_RESISTANCE, SoundType.PLANT)
	    .setCreativeTab(ModCreativeTabs.ALL);
    ...
    public static final Block MAELSTROM_BRICK_FENCE = new BlockFenceBase("maelstrom_brick_fence", Material.ROCK, BRICK_HARDNESS, STONE_RESISTANCE, SoundType.STONE)
	    .setCreativeTab(ModCreativeTabs.ALL);
    public static final Block MAELSTROM_BRICK_STAIRS = new BlockStairsBase("maelstrom_brick_stairs", MAELSTROM_BRICKS.getDefaultState(), BRICK_HARDNESS, STONE_RESISTANCE,
	    SoundType.STONE).setCreativeTab(ModCreativeTabs.ALL);
    ...
    public static final Block AZURE_REDSTONE_ORE = new BlockAzureRedstoneOre("azure_redstone_ore", ORE_HARDNESS, STONE_RESISTANCE, SoundType.STONE)
	    .setCreativeTab(ModCreativeTabs.ALL);
    ...
    public static final Block MAELSTROM_STONEBRICK = new BlockBase("maelstrom_stonebrick", Material.ROCK, STONE_HARDNESS, STONE_RESISTANCE, SoundType.STONE)
	    .setCreativeTab(ModCreativeTabs.ALL);
    public static final Block MAELSTROM_STONEBRICK_STAIRS = new BlockStairsBase("maelstrom_stonebrick_stairs", MAELSTROM_STONEBRICK.getDefaultState(), STONE_HARDNESS,
	    STONE_RESISTANCE, SoundType.STONE).setCreativeTab(ModCreativeTabs.ALL);
    public static final Block MAELSTROM_STONEBRICK_FENCE = new BlockFenceBase("maelstrom_stonebrick_fence", Material.ROCK, STONE_HARDNESS, STONE_RESISTANCE, SoundType.STONE)
	    .setCreativeTab(ModCreativeTabs.ALL);
    public static final Block AZURE_PORTAL = new BlockAzurePortal("azure_portal").setCreativeTab(ModCreativeTabs.ALL);

    // Maelstrom Fortress
    public static final Block AZURE_STONEBRICK = new BlockBase("azure_stonebrick", Material.ROCK, BRICK_HARDNESS, STONE_RESISTANCE, SoundType.STONE)
	    .setCreativeTab(ModCreativeTabs.ALL);
    public static final Block AZURE_STONEBRICK_STAIRS = new BlockStairsBase("azure_stonebrick_stairs", AZURE_STONEBRICK.getDefaultState(), BRICK_HARDNESS, STONE_RESISTANCE,
	    SoundType.STONE).setCreativeTab(ModCreativeTabs.ALL);
    public static final Block AZURE_STONEBRICK_CRACKED = new BlockBase("azure_stonebrick_cracked", Material.ROCK, BRICK_HARDNESS, STONE_RESISTANCE, SoundType.STONE)
	    .setCreativeTab(ModCreativeTabs.ALL);
    public static final Block AZURE_STONEBRICK_CARVED = new BlockBase("azure_stonebrick_carved", Material.ROCK, BRICK_HARDNESS, STONE_RESISTANCE, SoundType.STONE)
	    .setCreativeTab(ModCreativeTabs.ALL);
    public static final Block AZURE_STONEBRICK_CARVED_2 = new BlockBase("azure_stonebrick_carved_2", Material.ROCK, BRICK_HARDNESS, STONE_RESISTANCE, SoundType.STONE)
	    .setCreativeTab(ModCreativeTabs.ALL);
    public static final Block AZURE_STONEBRICK_CARVED_3 = new BlockBase("azure_stonebrick_carved_3", Material.ROCK, BRICK_HARDNESS, STONE_RESISTANCE, SoundType.STONE)
	    .setCreativeTab(ModCreativeTabs.ALL);
    public static final Block AZURE_STONEBRICK_LIT = new BlockBase("azure_stonebrick_lit", Material.ROCK, BRICK_HARDNESS, STONE_RESISTANCE, SoundType.STONE)
	    .setLightLevel(1.0f).setCreativeTab(ModCreativeTabs.ALL);
    ...
    public static final Block MAELSTROM_DUNGEON_KEY_BLOCK = new BlockAzureKey("azure_dungeon_key_block", null).setCreativeTab(ModCreativeTabs.ALL);
    public static final Block BROWN_KEY_BLOCK = new BlockBrownKey("brown_key_block", ModItems.BROWN_KEY).setCreativeTab(ModCreativeTabs.ALL);
    public static final Block RED_DUNGEON_KEY_BLOCK = new BlockAzureKey("red_dungeon_key_block", null).setCreativeTab(ModCreativeTabs.ALL);
    ...
    public static final Block RED_CLIFF_STONE = new BlockBase("red_cliff_stone", Material.ROCK, STONE_HARDNESS, STONE_RESISTANCE, SoundType.STONE)
	    .setCreativeTab(ModCreativeTabs.ALL);
    ...
    public static final Block FULL_SWAMP_LOG = new BlockFullLog("full_swamp_log", SWAMP_LOG).setHardness(WOOD_HARDNESS).setResistance(WOOD_RESISTANCE)
	    .setCreativeTab(ModCreativeTabs.ALL);
    ...
    public static final Block SWAMP_SAPLING = new BlockSaplingBase("swamp_sapling", Blocks.GRASS, PLANTS_HARDNESS, PLANTS_RESISTANCE, SoundType.PLANT,
	    new WorldGenSwampTree(true)).setCreativeTab(ModCreativeTabs.ALL);
    ...
    public static final Block CRACKED_GOLD_STONE = new BlockBase("cracked_gold_stone", Material.ROCK, BRICK_HARDNESS, STONE_RESISTANCE, SoundType.STONE)
	    .setCreativeTab(ModCreativeTabs.ALL);
    public static final Block GOLD_STONE_FENCE = new BlockFenceBase("gold_stone_fence", Material.ROCK, BRICK_HARDNESS, STONE_RESISTANCE, SoundType.STONE)
	    .setCreativeTab(ModCreativeTabs.ALL);
    public static final Block GOLD_STONE_STAIRS = new BlockStairsBase("gold_stone_stairs", GOLD_STONE.getDefaultState(), BRICK_HARDNESS, STONE_RESISTANCE, SoundType.STONE)
	    .setCreativeTab(ModCreativeTabs.ALL);
    public static final Block BROWNED_PILLAR = new BlockBase("browned_pillar", Material.ROCK, BRICK_HARDNESS, STONE_RESISTANCE, SoundType.STONE)
	    .setCreativeTab(ModCreativeTabs.ALL);
    public static final Block BROWNED_BLOCK = new BlockBase("browned_block", Material.ROCK, BRICK_HARDNESS, STONE_RESISTANCE, SoundType.STONE)
	    .setCreativeTab(ModCreativeTabs.ALL);
    public static final Block GOLD_STONE_LAMP = new BlockBase("gold_stone_lamp", Material.ROCK, BRICK_HARDNESS, STONE_RESISTANCE, SoundType.STONE).setLightLevel(1.0f)
	    .setCreativeTab(ModCreativeTabs.ALL);
    ...
    public static final Block SWAMP_PLANK_STAIRS = new BlockStairsBase("swamp_plank_stairs", SWAMP_PLANKS.getDefaultState(), WOOD_HARDNESS, WOOD_RESISTANCE, SoundType.WOOD)
	    .setCreativeTab(ModCreativeTabs.ALL);
    public static final Block SWAMP_FENCE = new BlockFenceBase("swamp_fence", Material.WOOD, WOOD_HARDNESS, WOOD_RESISTANCE, SoundType.WOOD)
	    .setCreativeTab(ModCreativeTabs.ALL);
    public static final Block CHISELED_CLIFF_STONE = new BlockBase("chiseled_cliff_stone", Material.ROCK, BRICK_HARDNESS, STONE_RESISTANCE, SoundType.STONE)
	    .setCreativeTab(ModCreativeTabs.ALL);
