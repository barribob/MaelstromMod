...
public class ChunkGeneratorAzure implements IChunkGenerator
{
    ...
    public static final int STRUCTURE_SPACING_CHUNKS = 32;
    public static final int MINESHAFT_STRUCTURE_NUMBER = 0;
    public static final int FORTRESS_STRUCTURE_NUMBER = 16;
	...
	for (int i = 0; i < 16; ++i)
	{
		...
		{
		    ((BiomeAzure) biome).generateAzureTerrain(this.world, this.rand, primer, x * 16 + i, z * 16 + j, this.depthBuffer[j + i * 16]);
		}
	    }
	}
    }
